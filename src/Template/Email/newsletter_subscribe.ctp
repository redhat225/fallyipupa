...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="600" style="border-collapse: collapse;border: 1.5px solid #cccccc;">
	<tr>
		<td align="center" bgcolor="#fff">
		  <img src="https://fallyipupa.riehl-emmanuel.xyz/img/newsletter/subscribe/top.png" alt="Tabernacle Official Logo" width="100%" style="display:block;" title="Fally_ipupa_official"/>
		</td>
	</tr>
	<tr>
		<td bgcolor="#fff" style="padding: 0px 30px 40px 30px;">
	...
	<tr>
		<td bgcolor="#6f2570" style="padding: 30px 30px 30px 30px;">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="75%">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td style="font-family: Helvetica, Arial, sans-serif;color:#fff; font-size: 14px;padding-left: 90px;"><b>Thanx!</b> <br /><b>Website Team</b></td>
							</tr>
						</table>
					</td>
					<td width="25%">
